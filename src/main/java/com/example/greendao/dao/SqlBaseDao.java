...
public class SqlBaseDao<T>{
    public static final String TAG = SqlBaseDao.class.getSimpleName();
    public static final boolean DUBUG = true;
    public SqlDbManager manager;
    public DaoSession daoSession;

    public SqlBaseDao(Context context) {
        manager = SqlDbManager.getInstance();
